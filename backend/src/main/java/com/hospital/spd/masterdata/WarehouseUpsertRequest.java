...
public record WarehouseUpsertRequest(
    ...
    public WarehouseUpsertRequest(String warehouseCode, String warehouseName, String warehouseType,
                                  String campusName, String deptCode, String deptName,
                                  Boolean participateStats, String statsCategories,
                                  Integer status, List<String> productCodes) {
        this(warehouseCode, warehouseName, warehouseType, campusName, deptCode, deptName,
                participateStats, statsCategories, null, status, productCodes);
    }
